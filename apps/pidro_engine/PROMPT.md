...
11. When you learn something new about how to run or play the game make sure you update @AGENT.md or the specs/ using a subagent but keep it brief. For example if you run commands multiple times before learning the correct command then that file should be updated.
...
14. Keep AGENT.md up to date with information on how to build the game and your learnings to optimise the build/test loop using a subagent.
...
18. SUPER IMPORTANT DO NOT IGNORE. DO NOT PLACE STATUS REPORT UPDATES INTO @AGENT.md
